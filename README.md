...
Соотношение рассчитанной и реальной проектных мощностей школ из датасета Москвы
![Точность](docs/accuracy_spb_moscow.png)
Рис.1 Распределение точности рассчитанной проектной мощности школ на объединённом датасете школ Санкт-Петербурга и Москвы
